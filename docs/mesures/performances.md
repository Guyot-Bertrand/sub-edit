...
| modification d'un texte, à travers une session | 114 ns | 0.2.14 — 2026-08-14 | 199 ns | 0.5.0 — 2026-08-22 |
...
<!-- modification d'un texte, à travers une session min=114.0 max=199.34 -->
