...
> **État actuel.** `subedit-cli` sait inspecter un fichier. Les commandes qui
> écrivent — conversion, décalage, transformation, fréquence d'image — sont en
> cours et n'existent pas encore ; voir la
